      ...
      child: Flex(
          ...
          children: [
            ...
            Expanded(
              ...
              items: [
                ProjectWidget(title: "Icard"),
                ProjectWidget(title: "GroupChatApp"),
                ProjectWidget(title: "SocialMediaApp"),
                ProjectWidget(title: "ToDoApp"),
                ProjectWidget(title: "WebView"),
                ProjectWidget(title: "Ecommerce"),
              ],
              height: 170,
